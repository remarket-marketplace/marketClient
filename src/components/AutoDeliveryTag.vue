...
<template>
  <span
    class="group relative inline-flex h-5 w-5 items-center justify-center rounded-[7px] border border-[rgb(var(--palette-blue-500)/0.7)] bg-[rgb(var(--palette-blue-950)/0.7)] text-[rgb(var(--palette-blue-100))]"
    role="button"
    tabindex="0"
  ...
  >
    ...
    <span
      class="auto-delivery-tooltip pointer-events-none absolute right-0 top-6 z-20 hidden w-max max-w-[150px] whitespace-normal rounded-md border border-[rgb(var(--palette-blue-400)/0.35)] px-2 py-1 text-center text-[10px] font-medium leading-tight text-[rgb(var(--palette-blue-100))] opacity-0 backdrop-blur-sm transition-opacity duration-150 group-hover:opacity-100 sm:block"
    >
    ...
    <span
      ...
      class="auto-delivery-tooltip auto-delivery-tooltip-mobile pointer-events-none fixed bottom-20 left-1/2 z-[70] w-[min(220px,calc(100vw-1rem))] -translate-x-1/2 rounded-md border border-[rgb(var(--palette-blue-400)/0.35)] px-2.5 py-1.5 text-center text-[11px] font-medium leading-tight text-[rgb(var(--palette-blue-100))] backdrop-blur-sm sm:hidden"
    >
      Мгновенная выдача после покупки
    </span>
  </span>
