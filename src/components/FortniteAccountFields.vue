...
const fieldClass = computed(() => [
  'w-full rounded-lg border border-[rgb(var(--palette-dark-700))] bg-[rgb(var(--palette-dark-600))] px-4 py-3 text-sm text-[rgb(var(--palette-white))] outline-none',
  props.disabled ? 'cursor-not-allowed opacity-70' : 'placeholder-[rgb(var(--palette-gray-500))]',
])
    ...
    <div v-if="textFields.length" class="space-y-3">
      ...
      <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <label class="space-y-2">
          ...
          <p
            v-if="hasLegacyCountryCode"
            class="text-xs text-[rgb(var(--palette-gray-500))]"
          >
