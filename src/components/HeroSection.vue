      ...
      <div class="relative z-[2] h-full px-5 pt-[clamp(2.75rem,5vw,4rem)] pb-[clamp(2rem,4vw,2.75rem)] sm:px-6 lg:px-8 min-[1400px]:px-10 max-[767px]:px-4 max-[767px]:pt-5 max-[767px]:pb-5">
        <div class="grid items-start gap-7 min-[1100px]:grid-cols-[minmax(0,35rem)_minmax(16rem,1fr)] min-[1100px]:gap-8">
          <div class="max-w-[36rem] min-[1100px]:pb-[0.15rem] max-[767px]:max-w-[20.5rem]">
            <h1 class="animate-fade-in-up mt-5 text-[clamp(2.55rem,5.5vw,4.45rem)] leading-[0.92] font-bold tracking-[-0.05em] text-[rgb(var(--palette-white))] max-[767px]:mt-0 max-[767px]:max-w-[18.75rem] max-[767px]:text-[clamp(2rem,9vw,3rem)] max-[767px]:leading-[0.94] [animation-delay:0.12s]">
            ...
            <p class="animate-fade-in-up mt-[1.15rem] max-w-[32rem] text-[clamp(0.98rem,1.35vw,1.06rem)] leading-[1.55] text-[rgb(var(--palette-gray-300)/0.94)] max-[767px]:mt-3 max-[767px]:max-w-[19rem] max-[767px]:text-[0.8rem] max-[767px]:leading-[1.34] [animation-delay:0.24s]">
              {{ t('hero.description') }}
            </p>
            ...
            <ul class="animate-fade-in-up mt-[1.1rem] flex flex-wrap gap-x-[1.15rem] gap-y-[0.85rem] p-0 max-[767px]:mt-3 max-[767px]:max-w-[19rem] max-[767px]:flex-col max-[767px]:gap-x-0 max-[767px]:gap-y-2 [animation-delay:0.24s]">
              <li
                ...
                :key="highlight"
                class="inline-flex items-start gap-[0.55rem] text-[0.88rem] leading-[1.35] text-[rgb(var(--palette-gray-200)/0.92)] max-[767px]:gap-2 max-[767px]:text-[0.76rem] max-[767px]:leading-[1.3]"
              >
