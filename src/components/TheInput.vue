...
<template>
  <div class="relative w-full">
    ...
    <input
      ...
      :minlength="minlength"
      :inputmode="inputmode"
      class="w-full rounded-lg bg-dark-500 border border-dark-200 px-4 py-2 text-mainText transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400 disabled:opacity-50 disabled:cursor-not-allowed"
      :class="{
        'pr-12': $slots.append
      }"
      v-bind="$attrs"
