  ...
  <Transition name="cookie-banner">
    ...
    >
      <div class="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div class="min-w-0">
          <div class="mb-2 inline-flex items-center gap-2 rounded-full border border-[rgb(var(--palette-blue-400)/0.25)] bg-[rgb(var(--palette-blue-500)/0.1)] px-2.5 py-1 text-[11px] font-medium text-[var(--text-accent)]">
            <Cookie class="h-3.5 w-3.5" />
            <span>{{ t('common.cookies.title') }}</span>
          </div>
          <p class="text-sm leading-relaxed text-[var(--text-body-strong)]">
            {{ t('common.cookies.description') }}
            <router-link to="/privacy-policy" class="ml-1 text-[var(--text-link)] underline-offset-2 hover:text-[var(--text-accent)] hover:underline">
        ...
        <div class="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:justify-end">
          <button
            type="button"
            class="rounded-lg border border-[rgb(var(--palette-white)/0.15)] px-3 py-2 text-sm text-[var(--text-body-strong)] transition hover:border-[rgb(var(--palette-white)/0.3)] hover:bg-[rgb(var(--palette-white)/0.05)]"
          ...
          <button
            type="button"
            class="rounded-lg border border-[rgb(var(--palette-blue-400)/0.35)] bg-[rgb(var(--palette-blue-500)/0.1)] px-3 py-2 text-sm text-[var(--text-accent-strong)] transition hover:bg-[rgb(var(--palette-blue-500)/0.2)]"
          ...
          <button
            type="button"
            class="rounded-lg bg-[rgb(var(--palette-blue-600))] px-3 py-2 text-sm font-medium text-[var(--text-title)] transition hover:bg-[rgb(var(--palette-blue-500))]"
    ...
    >
      <div class="cookie-modal-surface w-full max-w-xl rounded-2xl border border-[rgb(var(--palette-white)/0.15)] bg-[rgb(var(--palette-dark-900))] p-4 text-mainText sm:p-5">
        <div class="mb-4 flex items-start justify-between gap-3">
          <div>
            <h3 class="text-base font-semibold text-[var(--text-title)]">{{ t('common.cookies.modalTitle') }}</h3>
            <p class="mt-1 text-sm text-[var(--text-body)]">{{ t('common.cookies.modalDescription') }}</p>
          </div>
          <button
            type="button"
            class="rounded-md border border-[rgb(var(--palette-white)/0.15)] px-2 py-1 text-xs text-[var(--text-body)] transition hover:border-[rgb(var(--palette-white)/0.3)] hover:text-[var(--text-title)]"
        ...
        <div class="space-y-2.5">
          <div class="rounded-xl border border-[rgb(var(--palette-white)/0.1)] bg-[rgb(var(--palette-white)/0.04)] p-3">
            <div class="grid grid-cols-[minmax(0,1fr)_132px] items-center gap-3">
              <div class="min-w-0">
                <p class="text-sm font-medium text-[var(--text-title)]">{{ t('common.cookies.necessary') }}</p>
                <p class="mt-0.5 text-xs text-[var(--text-muted)]">{{ t('common.cookies.necessaryDescription') }}</p>
              </div>
              <div class="flex justify-end">
                <span class="inline-flex w-[124px] justify-center whitespace-nowrap items-center gap-1 rounded-full border border-[rgb(var(--palette-emerald-400)/0.3)] bg-[rgb(var(--palette-emerald-500)/0.1)] px-2 py-0.5 text-[11px] text-[var(--text-success)]">
          ...
          <div class="rounded-xl border border-[rgb(var(--palette-white)/0.1)] bg-[rgb(var(--palette-white)/0.04)] p-3">
            <div class="grid grid-cols-[minmax(0,1fr)_132px] items-center gap-3">
              <div class="min-w-0">
                <p class="text-sm font-medium text-[var(--text-title)]">{{ t('common.cookies.analytics') }}</p>
                <p class="mt-0.5 text-xs text-[var(--text-muted)]">{{ t('common.cookies.analyticsDescription') }}</p>
              </div>
              <div class="flex justify-end">
                <button
                  type="button"
          ...
          <div class="rounded-xl border border-[rgb(var(--palette-white)/0.1)] bg-[rgb(var(--palette-white)/0.04)] p-3">
            <div class="grid grid-cols-[minmax(0,1fr)_132px] items-center gap-3">
              <div class="min-w-0">
                <p class="text-sm font-medium text-[var(--text-title)]">{{ t('common.cookies.marketing') }}</p>
                <p class="mt-0.5 text-xs text-[var(--text-muted)]">{{ t('common.cookies.marketingDescription') }}</p>
              </div>
              <div class="flex justify-end">
                <button
                  type="button"
