...
<template>
  ...
  >
    ...
    <div class="mb-2 aspect-square w-full overflow-hidden rounded-xl bg-gray-700 flex-shrink-0">
      ...
      <div
        v-else
        class="w-full h-full flex items-center justify-center text-sm text-gray-300"
      >
        {{ t('common.noImage') }}
      </div>
    </div>
    ...
    <div class="mt-auto flex items-center justify-between gap-2">
      ...
      >
        <span
          class="block transition-all duration-200 group-hover:-translate-y-full group-hover:opacity-0"
        >
          {{ product.price }}₽
        </span>
        <span
