  ...
  pages: {
    ...
    admin: {
      ...
      mainPage: {
        ...
        financeSettingsTitle: "Platform finance",
        financeSettingsHint: "Configure platform commissions and the Telegram Stars rate.",
        ...
        financeSettingsSnapshotHint: "Changes apply only to new deals and withdrawal requests.",
