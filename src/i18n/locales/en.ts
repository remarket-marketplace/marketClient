const en = {
  ...
  errors: {
    ...
    TELEGRAM_STARS_DISABLED: "Telegram Stars purchase is temporarily unavailable",
    ...
    STEAM_TOPUP_ACCOUNT_CURRENCY_MISMATCH: "Steam account region does not match the selected wallet currency",
  ...
  pages: {
    ...
    index: {
      ...
      telegramStars: {
        ...
        loadingPricing: "Loading current star price...",
        disabled: "Telegram Stars purchase is temporarily disabled.",
        authHint: "Sign in to purchase stars.",
        success: "Telegram Stars purchase completed successfully.",
        priceBadge: "{price} per star",
      },
      steamTopUp: {
        title: "Top up wallet",
        navLabel: "Top up",
        ...
        service: "Service",
        currency: "Steam wallet currency",
        ...
        redirectToPayment: "Charging your balance...",
    ...
    settingsPage: {
      ...
      security: "Security",
      securityHint: "Email code sign-in",
      ...
      passwordlessHint: "Passwords are no longer used: sign in by confirming the code from your email.",
      passwordlessCardTitle: "Email codes protect sign-in",
      passwordlessCardText: "Each sign-in sends a one-time 6-digit code to your email. Password changes and a separate two-factor toggle are no longer needed.",
      passwordlessPoint1Title: "One-time code",
      passwordlessPoint1Text: "The code is time-limited and checked only for the selected email.",
      passwordlessPoint2Title: "Less account data",
      passwordlessPoint2Text: "Your account does not need a user password for normal sign-in.",
      passwordlessPoint3Title: "Email matters",
      passwordlessPoint3Text: "Keep your email account protected because it confirms access to this account.",
      ...
      tip1: "Do not share sign-in codes with anyone",
      tip2: "Check the site address before entering a code",
      tip3: "Protect your email with a strong sign-in method",
    ...
    wallet: {
      ...
      paymentProviderTitle: "Cards, SPB, crypto",
      ...
      withdrawMethodCrypto: "To Crypto",
      withdrawMethodCryptoHint: "TRC-20",
      withdrawMethodCard: "To Card",
      withdrawMethodSoon: "Coming soon",
    ...
    admin: {
      ...
      mainPage: {
        ...
        financeSettingsHint: "Configure platform commissions, Telegram Stars rate, and VPN prices for each period.",
        ...
        telegramStarsPriceLabel: "Telegram Stars, ₽/unit",
        telegramStarsPriceHint: "Price of one Telegram Star on remarket. 0 disables purchase.",
