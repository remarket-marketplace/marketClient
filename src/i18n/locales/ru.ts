  ...
  pages: {
    ...
    settingsPage: {
      ...
      nicknameStyleCatalog: {
        default: {
          name: "Классика",
          description: "Базовый чистый стиль отображения ника",
        },
        neon_pulse: {
          name: "Неон Пульс",
          description: "Яркое циановое свечение с мягкой пульсацией",
        },
        gold_royal: {
          name: "Королевское золото",
          description: "Премиальный золотой градиент с блеском",
        },
        cyber_glitch: {
          name: "Кибер Глитч",
          description: "Киберпанк-стиль с эффектом раздвоения цвета",
        },
        sunset_wave: {
          name: "Закатная волна",
          description: "Теплый оранжево-розовый градиент заката",
        },
        ice_frost: {
          name: "Ледяной иней",
          description: "Холодный кристальный оттенок с морозным свечением",
        },
        emerald_glow: {
          name: "Изумрудное свечение",
          description: "Зеленый неоновый стиль с насыщенным glow-эффектом",
        },
        lava_burst: {
          name: "Вспышка лавы",
          description: "Огненный красно-оранжевый градиент",
        },
        aurora_spectrum: {
          name: "Спектр Авроры",
          description: "Многоцветный градиент северного сияния",
        },
        candy_pop: {
          name: "Кэнди Поп",
          description: "Яркая конфетная палитра розового и фиолетового",
        },
        shadow_void: {
          name: "Теневой Войд",
          description: "Мистический темно-фиолетовый стиль с глубиной",
        },
        sky_bolt: {
          name: "Небесный разряд",
          description: "Электрический синий градиент с динамикой",
        },
        matrix_code: {
          name: "Код Матрицы",
          description: "Цифровой зеленый стиль в духе терминала",
        },
      },
    },
