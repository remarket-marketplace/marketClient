...
const ru = {
  ...
  pages: {
    ...
    settingsPage: {
      ...
      nicknameStylesMenu: "Стили ника",
      nicknameStylesHint: "Покупка и переключение эффектов ника",
      ...
      nicknameStylesSectionTitle: "Магазин стилей ника",
      nicknameStylesSectionHint: "Покупайте стили и переключайте уже купленные в любой момент.",
