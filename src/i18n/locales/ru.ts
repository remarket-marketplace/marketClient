const ru = {
  common: {
    ...
    product: "Продукт",
    remarket: "xmarket - маркет Telegram ников",
    support: "Поддержка",
    ...
    tagline: "Площадка для покупки и продажи Telegram-ников.",
    ...
    trust: {
      ...
      sellersText: "Проверенные продавцы и модерация",
  ...
  pages: {
    ...
    index: {
      searchPlaceholder: "Поиск премиум-ников Telegram и X-хэндлов...",
      selectCategory: "Выбрать категорию",
      allSubcategories: "Все подкатегории",
      noProducts: "Нет лотов по выбранным фильтрам",
      filtersTitle: "Фильтры",
      priceFrom: "Цена от",
      priceTo: "Цена до",
      resetFilters: "Сбросить",
      platformTabsTitle: "Фокус по категории",
      platformTabs: {
      ...
      anonymousNumbers: {
        eyebrow: "Анонимные номера",
        title: "Коллекция +888 для приватного владения",
        description: "Номера +888 это TON NFT-активы с высокой маржой. Разделение на Gold и Silver помогает быстро отличать элитные лоты от входных позиций.",
      },
      filters: {
      ...
      catalogTitles: {
        telegram: "Каталог Telegram-юзернеймов",
        numbers: "Каталог анонимных +888 номеров",
        x: "Каталог X-хэндлов",
      },
      filteredCount: "{count} лотов",
    },
    ...
    about: {
      title: "О нас",
      subtitle: "xmarket — это маркетплейс Telegram-ников, где доверие строится на прозрачных правилах, поддержке и предсказуемом процессе.",
      ...
      ideaText1: "Идея xmarket — соединить удобство классического маркетплейса с механизмами контроля сделки: структурированные карточки товара, коммуникация в одном месте и понятный жизненный цикл заказа.",
      ...
      futureText1: "Мы развиваем xmarket как инфраструктуру доверия: улучшаем качество модерации, удобство коммуникации и инструменты оценки надежности продавцов.",
  ...
  hero: {
    badge: "Escrow-защищенный маркет",
    mainTitle: "Рынок премиальных Telegram-юзернеймов",
    mainTitleGradient: "и X-хэндлов",
    description: "Безопасный escrow для покупки и продажи Telegram-юзернеймов и X-хэндлов.",
    ...
    highlights: {
      usernames: "Премиум-юзернеймы",
      escrow: "Безопасный Escrow",
      xHandles: "Премиум X-хэндлы",
    },
    panel: {
      liveMarket: "Live market",
      online: "online",
      escrowTitle: "Escrow 24h",
      escrowSub: "защита покупателя",
      tonTitle: "Instant TON",
      tonSub: "моментальный перевод",
      auditTitle: "X Audit",
      auditSub: "проверка shadowban",
