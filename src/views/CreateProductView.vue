...
<template>
  <div class="w-full h-full overflow-scroll no-scrollbar lg:overflow-hidden md:pb-0">
    <div class="mb-6 lg:hidden px-4 pt-4">
      ...
      <p class="mt-2 text-xs text-[rgb(var(--palette-blue-300))]">
      ...
      <div class="mx-auto w-full max-w-5xl space-y-6 px-4 lg:px-6 lg:pt-6" @keydown.capture.enter="handleWizardEnter">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div v-if="isStandardCreateFlow" class="space-y-1">
            ...
            <p v-if="formattedDraftSavedAt" class="text-xs text-[rgb(var(--palette-blue-300))]">
          ...
          <button
            ...
            class="inline-flex items-center gap-1.5 rounded-md border border-[rgb(var(--palette-dark-600))] bg-[rgb(var(--palette-dark-700)/0.4)] px-3 py-1.5 text-xs font-medium text-[rgb(var(--palette-gray-300))] transition-colors hover:border-[rgb(var(--palette-dark-500))] hover:bg-[rgb(var(--palette-dark-700)/0.7)] hover:text-[rgb(var(--palette-white))] disabled:opacity-45 disabled:cursor-not-allowed"
        ...
        <div
          ...
          class="rounded-xl border border-[rgb(var(--palette-blue-500)/0.3)] bg-[rgb(var(--palette-blue-500)/0.1)] px-4 py-3 text-sm text-[rgb(var(--palette-blue-100))]"
        >
            ...
            >
              <div class="flex items-center gap-2 min-w-0">
                <span
                  ...
                  :class="[
                    currentStep === step.id
                      ? 'bg-[rgb(var(--palette-blue-500))] text-[rgb(var(--palette-white))]'
                      : step.isValid
                        ? 'bg-[rgb(var(--palette-green-500))] text-[rgb(var(--palette-white))]'
                        : 'bg-[rgb(var(--palette-dark-700))] text-[rgb(var(--palette-gray-300))]',
                  ]"
                >
                  {{ step.id }}
                </span>
                <p class="truncate text-xs lg:text-sm font-medium text-[rgb(var(--palette-white))]">
                  {{ step.shortTitle }}
                </p>
              </div>
              ...
              <Check
                v-if="step.isValid"
                class="h-4 w-4 shrink-0 text-[rgb(var(--palette-green-400))]"
              />
            </button>
          </div>
        </div>
        ...
        <Transition :name="stepTransitionName" mode="out-in">
          ...
          >
            <header class="space-y-2">
              <h2 class="text-lg lg:text-xl font-semibold text-[rgb(var(--palette-white))]">
                {{ stepHeader.title }}
              </h2>
            ...
            <template v-if="currentStep === 1">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-2">
                  <label class="text-sm font-medium text-[rgb(var(--palette-gray-300))]">
                    {{ $t('common.category') }}
                    <span class="text-xs text-[rgb(var(--palette-red-400))] ml-1">*</span>
                  </label>
                  <CustomSelect
              ...
              <p
                ...
                class="text-xs leading-relaxed text-[rgb(var(--palette-blue-300))]"
              >
            ...
            <template v-else-if="currentStep === 2">
              <div class="space-y-6">
                <div class="space-y-2">
                  <label for="title" class="text-sm font-medium text-[rgb(var(--palette-gray-300))]">
                  ...
                  <input
                    ...
                    class="w-full rounded-lg bg-[rgb(var(--palette-dark-600))] border border-[rgb(var(--palette-dark-700))] px-4 py-3 text-sm text-[rgb(var(--palette-white))] outline-none placeholder-[rgb(var(--palette-gray-500))]"
                  />
                  <div class="flex items-center justify-between gap-3">
                    <p class="text-xs" :class="titleLengthValid ? 'text-[rgb(var(--palette-gray-400))]' : 'text-[rgb(var(--palette-red-400))]'">
                      {{
                        t('pages.forms.createProduct.validationTitleLength', {
                          min: PRODUCT_LIMITS.title.min,
                          max: PRODUCT_LIMITS.title.max,
                    ...
                    <p class="text-xs text-[rgb(var(--palette-gray-400))] text-right">
                ...
                <div class="space-y-2">
                  <label for="description" class="text-sm font-medium text-[rgb(var(--palette-gray-300))]">
                  ...
                  <textarea
                    ...
                    class="w-full rounded-lg bg-[rgb(var(--palette-dark-600))] border border-[rgb(var(--palette-dark-700))] px-4 py-3 text-sm outline-none text-[rgb(var(--palette-white))] placeholder-[rgb(var(--palette-gray-500))] resize-none"
                  ></textarea>
                  <div class="flex items-center justify-between gap-3">
                    <p class="text-xs" :class="descriptionLengthValid ? 'text-[rgb(var(--palette-gray-400))]' : 'text-[rgb(var(--palette-red-400))]'">
                      {{
                        t('pages.forms.createProduct.validationDescriptionLength', {
                          min: PRODUCT_LIMITS.description.min,
                          max: PRODUCT_LIMITS.description.max,
                ...
                >
                  <div class="space-y-1">
                    <h4 class="text-sm font-semibold text-[rgb(var(--palette-white))]">
                      {{ $t('pages.forms.createProduct.fortniteAccountDetailsTitle') }}
                    </h4>
                    <p class="text-xs text-[rgb(var(--palette-gray-400))] leading-relaxed">
                      {{
                        isRaikaDraftApplied
                  ...
                  <p
                    class="text-xs"
                    :class="fortniteAccountDataValid ? 'text-[rgb(var(--palette-gray-400))]' : 'text-[rgb(var(--palette-red-400))]'"
                  >
                    {{ $t('pages.forms.createProduct.validationFortniteAccountDetailsRequired') }}
                  </p>
                </div>
                ...
                <div class="rounded-xl border border-[rgb(var(--palette-dark-700))] bg-[rgb(var(--palette-dark-600)/0.4)] p-5 space-y-3">
                  ...
                  <div v-if="autoDelivery" class="p-3 rounded-lg bg-[rgb(var(--palette-blue-900)/0.2)] border border-[rgb(var(--palette-blue-800)/0.3)]">
                    <p class="text-xs text-[rgb(var(--palette-blue-300))] leading-relaxed flex items-start gap-2">
                ...
                >
                  <div class="flex items-center justify-between">
                    <div class="space-y-1">
                      ...
                      <p class="text-xs text-[rgb(var(--palette-blue-200)/0.85)] leading-relaxed">
                ...
                <div v-if="autoDelivery" class="space-y-2">
                  <div class="flex items-center gap-2">
                    <label for="productData" class="text-sm font-medium text-[rgb(var(--palette-gray-300))]">
                      {{ $t('pages.forms.createProduct.productData') }}
                      <span class="text-xs text-[rgb(var(--palette-red-400))] ml-1">*</span>
                    </label>
                    <div class="flex items-center gap-1 text-xs text-[rgb(var(--palette-blue-400))]">
                      <Info class="w-3 h-3" />
                  ...
                  <textarea
                    ...
                    class="w-full rounded-lg bg-[rgb(var(--palette-dark-600))] border border-[rgb(var(--palette-dark-700))] px-4 py-3 text-sm outline-none text-[rgb(var(--palette-white))] placeholder-[rgb(var(--palette-gray-500))] resize-none font-mono"
                  ></textarea>

                  <div class="flex items-center justify-between gap-3">
                    <p class="text-xs" :class="productDataLengthValid ? 'text-[rgb(var(--palette-gray-400))]' : 'text-[rgb(var(--palette-red-400))]'">
                      {{
                        t('pages.forms.createProduct.validationProductDataLength', {
                          min: PRODUCT_LIMITS.productData.min,
                          max: PRODUCT_LIMITS.productData.max,
              ...
              <div class="space-y-5">
                ...
                <div v-if="draftImages.length > 0" class="space-y-3">
                  <div class="flex items-center justify-between">
                    ...
                    <span class="text-xs text-[rgb(var(--palette-gray-400))]">
                    ...
                    >
                      ...
                      <div class="absolute inset-0 bg-[rgb(var(--palette-black)/0)] group-hover:bg-[rgb(var(--palette-black)/0.4)] transition-all duration-200 flex items-center justify-center">
                        <button
                          ...
                          class="rounded-full border border-[rgb(var(--palette-white)/0.1)] bg-[rgb(var(--palette-dark-900)/0.9)] p-2 text-[rgb(var(--palette-gray-200))] opacity-0 transition-all duration-200 group-hover:opacity-100 hover:border-[rgb(var(--palette-white)/0.2)] hover:bg-[rgb(var(--palette-dark-900))] hover:text-[rgb(var(--palette-white))]"
            ...
            <template v-else>
              <div class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="space-y-3">
                    <div class="flex h-6 items-center justify-between">
                      <label for="price" class="text-sm font-medium text-[rgb(var(--palette-gray-300))]">
                        {{ $t('common.price') }}
                        <span class="text-xs text-[rgb(var(--palette-red-400))] ml-1">*</span>
                      </label>
                      <div class="flex items-center gap-2">
                        <Calculator class="w-4 h-4 text-[rgb(var(--palette-blue-400))]" />
                        <span class="text-xs text-[rgb(var(--palette-gray-400))]">{{ currencySymbol }}</span>
                      </div>
                    </div>
                    <div class="relative">
                      <input
                        ...
                        class="h-12 w-full rounded-lg border border-[rgb(var(--palette-dark-700))] bg-[rgb(var(--palette-dark-600))] px-4 pr-16 text-base font-semibold text-[rgb(var(--palette-white))] outline-none"
                      />
                      <div class="absolute right-3 top-1/2 -translate-y-1/2 text-[rgb(var(--palette-gray-300))] text-sm font-medium">
                        {{ currencySymbol }}
                      </div>
                    </div>
                    <p class="text-xs" :class="priceValid ? 'text-[rgb(var(--palette-gray-400))]' : 'text-[rgb(var(--palette-red-400))]'">
                      {{
                        t('pages.forms.createProduct.validationPriceRange', {
                  ...
                  <div class="space-y-3">
                    <div class="flex h-6 items-center">
                      <label for="count" class="text-sm font-medium text-[rgb(var(--palette-gray-300))]">
                    ...
                    <div class="relative">
                      <input
                        ...
                        step="1"
                        inputmode="numeric"
                        class="h-12 w-full rounded-lg border border-[rgb(var(--palette-dark-700))] bg-[rgb(var(--palette-dark-600))] px-4 pr-20 text-base font-semibold text-[rgb(var(--palette-white))] outline-none"
                      />
                      <div class="absolute right-3 top-1/2 -translate-y-1/2 text-[rgb(var(--palette-gray-400))] text-sm">
                        {{ $t('common.items') }}
                      </div>
                    </div>
                    <p class="text-xs" :class="countValid ? 'text-[rgb(var(--palette-gray-400))]' : 'text-[rgb(var(--palette-red-400))]'">
                      {{
                        t('pages.forms.createProduct.validationCountRange', {
                          min: PRODUCT_LIMITS.count.min,
                          max: PRODUCT_LIMITS.count.max,
                ...
                <div class="rounded-xl border border-[rgb(var(--palette-dark-700))] bg-[rgb(var(--palette-dark-600)/0.4)] p-5 space-y-4">
                  <h3 class="text-sm font-semibold text-[rgb(var(--palette-white))] flex items-center gap-2">
                    <Percent class="w-4 h-4 text-[rgb(var(--palette-blue-400))]" />
                    {{ $t('pages.forms.createProduct.calculations') }}
                  </h3>

                  <div class="space-y-3">
                    <div class="flex items-center justify-between">
                      <span class="text-sm text-[rgb(var(--palette-gray-400))]">{{ $t('pages.forms.createProduct.totalPrice') }}:</span>
                      <span class="text-sm font-medium text-[rgb(var(--palette-white))]">
                        {{ formatPrice(totalPriceInRub) }}
                      </span>
                    </div>

                    <div class="flex items-center justify-between">
                      <span class="text-sm text-[rgb(var(--palette-gray-400))]">
                        {{ $t('pages.forms.createProduct.commission') }}:
                        <span v-if="commissionInterest !== null" class="text-[rgb(var(--palette-blue-400))] ml-1">
                          ({{ commissionInterest }}%)
                        </span>
                      </span>
                      <span class="text-sm font-medium text-[rgb(var(--palette-red-400))]">
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <span class="text-lg font-bold text-[rgb(var(--palette-green-400))]">
                  ...
                  <div v-if="commissionInterest !== null" class="mt-4 p-3 rounded-lg bg-[rgb(var(--palette-blue-900)/0.2)] border border-[rgb(var(--palette-blue-800)/0.3)]">
                    <p class="text-xs text-[rgb(var(--palette-blue-300))] leading-relaxed">
                      {{ $t('pages.forms.createProduct.commissionNote', { percent: commissionInterest }) }}
                    </p>
                  </div>
                </div>

                <div class="text-xs text-[rgb(var(--palette-gray-400))] space-y-2">
                  <div class="flex items-start gap-2 p-3 bg-[rgb(var(--palette-dark-700)/0.3)] rounded-lg">
                    <AlertCircle class="w-4 h-4 text-[rgb(var(--palette-yellow-400))] mt-0.5 flex-shrink-0" />
                    <p>
                      {{ $t('pages.forms.createProduct.termsNote') }}
                      <router-link to="/terms" class="text-[rgb(var(--palette-blue-400))] hover:text-[rgb(var(--palette-blue-300))] hover:underline transition-colors">
        ...
        >
          <p class="text-xs text-[rgb(var(--palette-amber-200))] font-medium mb-2">
          ...
          <ul class="space-y-1">
            <li
              ...
              :key="issue"
              class="text-xs text-[rgb(var(--palette-amber-300))]"
            >
              • {{ issue }}
            </li>
          </ul>
        ...
        <div class="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pb-6">
          <button
            type="button"
            class="rounded-lg border border-[rgb(var(--palette-dark-700))] bg-[rgb(var(--palette-dark-600)/0.4)] px-4 py-3 text-sm font-semibold text-[rgb(var(--palette-gray-200))] transition-colors duration-200 hover:border-[rgb(var(--palette-dark-500))] hover:bg-[rgb(var(--palette-dark-600))]"
          ...
          >
            <span v-if="sended" class="flex items-center justify-center gap-2">
              <svg class="animate-spin h-4 w-4 text-[rgb(var(--palette-white))]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    >
      <div class="rounded-[1.4rem] border border-[rgb(var(--palette-white)/0.08)] bg-[rgb(var(--palette-white)/0.03)] px-5 py-4 sm:px-6 sm:py-5">
        <p class="text-xs font-semibold uppercase tracking-[0.22em] text-[rgb(var(--palette-gray-500))]">
          {{ $t('pages.forms.createProduct.successHintLabel') }}
        </p>
        <p class="mt-3 break-words text-[15px] leading-8 text-[rgb(var(--palette-gray-300))]">
      ...
      <template #footer>
        <div class="flex flex-col gap-3 sm:flex-row">
          <button
            type="button"
            class="market-primary-surface market-primary-hover inline-flex min-h-14 flex-1 items-center justify-center rounded-[1.15rem] px-5 py-4 text-base font-semibold text-[rgb(var(--palette-white))] transition-colors duration-200"
