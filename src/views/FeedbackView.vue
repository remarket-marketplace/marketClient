      ...
      <form class="space-y-6" @submit.prevent="submitFeedback">
        ...
        <div class="rounded-xl border border-[rgb(var(--palette-dark-700))] bg-[rgb(var(--palette-dark-600)/0.4)] p-5 space-y-3">
          <div class="flex items-center gap-2">
            <MessageSquareText class="w-4 h-4 text-[rgb(var(--palette-blue-400))]" />
            <label for="feedback-text" class="text-sm font-medium text-[rgb(var(--palette-gray-300))]">
          ...
          <div class="flex items-center justify-between text-xs">
            <span class="text-[rgb(var(--palette-gray-500))]">
        ...
        <div class="rounded-xl border border-[rgb(var(--palette-dark-700))] bg-[rgb(var(--palette-dark-600)/0.4)] p-5 space-y-3">
          <div class="flex items-center gap-2 text-sm text-[rgb(var(--palette-gray-300))]">
            <ImagePlus class="w-4 h-4 text-[rgb(var(--palette-blue-400))]" />
        ...
        <div class="rounded-xl border border-[rgb(var(--palette-dark-700))] bg-[rgb(var(--palette-dark-600)/0.4)] p-5 space-y-4">
          <h3 class="text-sm font-semibold text-[rgb(var(--palette-white))] flex items-center gap-2">
            <Lightbulb class="w-4 h-4 text-[rgb(var(--palette-blue-400))]" />
            {{ $t("pages.feedback.tipsTitle") }}
          </h3>

          <div class="space-y-3 text-sm text-[rgb(var(--palette-gray-300))]">
        ...
        <div class="space-y-3">
          <button
            ...
            :class="isSending || !isFormValid
              ? 'bg-[rgb(var(--palette-dark-600))] text-[rgb(var(--palette-gray-400))] border border-[rgb(var(--palette-dark-700))]'
          ...
          <p class="text-xs text-[rgb(var(--palette-gray-500))] leading-relaxed">
