...
<template>
  ...
  <section class="relative w-full flex flex-col items-center">
    ...
    >
          ...
          <div v-else class="w-full">
            <div class="relative">
                ...
                <div class="flex min-w-max gap-2 py-1.5 sm:gap-3 sm:py-2">
                  ...
                  >
                    <div class="h-12 w-12 flex items-center justify-center bg-[rgb(var(--palette-dark-700))] rounded-lg overflow-hidden border border-[rgb(var(--palette-white)/0.05)] shadow-inner sm:h-16 sm:w-16">
                      ...
                      />
                      <Folder v-else class="h-6 w-6 text-[rgb(var(--palette-gray-400))] sm:h-8 sm:w-8" />
                    </div>
              ...
              <button
                ...
                type="button"
                class="home-category-expand-btn market-primary-surface market-primary-hover absolute right-1 top-1/2 z-10 inline-flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-[rgb(var(--palette-blue-400)/0.25)] text-[rgb(var(--palette-white))] ring-4 ring-[rgb(var(--palette-dark-800)/0.55)] transition disabled:cursor-default disabled:opacity-60 sm:h-12 sm:w-12"
            ...
            >
              ...
              <button
                ...
                type="button"
                class="home-expanded-category-card flex w-full flex-col items-center rounded-lg p-1 text-[rgb(var(--palette-white))] transition disabled:cursor-default disabled:opacity-60 sm:p-1.5"
                :aria-expanded="areCategoriesExpanded"
            ...
            <div v-if="isFiltersOpen" class="mt-3 w-full rounded-2xl border border-[rgb(var(--palette-dark-700))] bg-[rgb(var(--palette-dark-600)/0.25)] p-4 md:p-5">
              <div class="flex flex-wrap items-center justify-between gap-3">
                <div class="flex flex-wrap gap-2">
                  <button
                    ...
                    :class="isPricePresetActive(preset)
                      ? 'border-[rgb(var(--palette-blue-400)/0.4)] bg-[rgb(var(--palette-blue-500)/0.1)] text-[rgb(var(--palette-blue-200))]'
                      : 'border-[rgb(var(--palette-dark-600))] bg-[rgb(var(--palette-dark-700)/0.3)] text-[rgb(var(--palette-gray-300))] hover:bg-[rgb(var(--palette-dark-700)/0.5)] hover:text-[rgb(var(--palette-white))]'"
                ...
                <button
                  v-if="activeProductFiltersCount > 0"
                  type="button"
                  class="text-xs font-semibold text-[rgb(var(--palette-gray-400))] transition hover:text-[rgb(var(--palette-white))]"
              ...
              <div class="mt-4 grid grid-cols-1 gap-3 md:grid-cols-2">
                <label class="rounded-xl border border-[rgb(var(--palette-dark-600))] bg-[rgb(var(--palette-dark-700)/0.3)] px-3 py-2.5 transition focus-within:border-[rgb(var(--palette-blue-400)/0.4)] focus-within:bg-[rgb(var(--palette-dark-700)/0.55)]">
                  <span class="block text-xs text-[rgb(var(--palette-gray-400))]">{{ t('pages.index.priceFrom') }}</span>
                  <div class="mt-1.5 flex items-center gap-2">
                    <input
                      ...
                      min="0"
                      inputmode="decimal"
                      class="w-full bg-[var(--transparent)] text-sm text-[rgb(var(--palette-white))] outline-none placeholder-[rgb(var(--palette-gray-500))]"
                      :placeholder="t('pages.index.priceFrom')"
                      @input="debouncedApplyProductFilters"
                    />
                    <span class="text-xs font-semibold text-[rgb(var(--palette-gray-400))]">{{ currencySymbol }}</span>
                  </div>
                </label>

                <label class="rounded-xl border border-[rgb(var(--palette-dark-600))] bg-[rgb(var(--palette-dark-700)/0.3)] px-3 py-2.5 transition focus-within:border-[rgb(var(--palette-blue-400)/0.4)] focus-within:bg-[rgb(var(--palette-dark-700)/0.55)]">
                  <span class="block text-xs text-[rgb(var(--palette-gray-400))]">{{ t('pages.index.priceTo') }}</span>
                  <div class="mt-1.5 flex items-center gap-2">
                    <input
        ...
        <div v-else-if="products.length === 0" class="text-center text-[rgb(var(--palette-gray-400))] py-20">
  ...
  <Teleport to="body">
    ...
    >
      <p class="px-2 pb-1 text-[11px] font-semibold uppercase tracking-[0.12em] text-[rgb(var(--palette-gray-400)/0.85)]">
      ...
      <button
        ...
        type="button"
        class="flex w-full items-center gap-2.5 rounded-xl px-2.5 py-2 text-left text-sm text-[rgb(var(--palette-white))] transition duration-200"
        :class="{
      ...
      >
        <span class="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-[rgb(var(--palette-white)/0.1)] bg-[rgb(var(--palette-dark-800)/0.8)]">
          ...
          />
          <Folder v-else class="h-4 w-4 text-[rgb(var(--palette-gray-400))]" />
        </span>
