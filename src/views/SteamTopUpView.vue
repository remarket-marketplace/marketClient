  ...
  <section class="steam-topup-page -mt-14 relative min-h-[calc(100dvh-3.5rem)] overflow-hidden pt-14">
    ...
    <div class="relative mx-auto flex min-h-[calc(100dvh-3.5rem)] w-full max-w-5xl flex-col px-4 pb-14 pt-6 sm:px-6 lg:px-8">
      <div class="mb-10 flex items-center justify-between">
        <BackButton />
        <div class="inline-flex items-center gap-2 rounded-full border border-[rgb(var(--palette-white)/0.08)] bg-[rgb(var(--palette-white)/0.03)] px-3 py-1.5 text-xs font-medium tracking-[0.18em] text-[rgb(var(--palette-gray-400))] uppercase">
          <Icon icon="mdi:steam" class="h-4 w-4 text-[rgb(var(--palette-white)/0.9)]" />
          Steam
        </div>
      </div>
      ...
      <div class="mx-auto flex w-full max-w-[680px] flex-1 flex-col justify-center">
        <div class="mx-auto mb-8 max-w-lg text-center">
          <h1 class="text-balance text-3xl font-semibold tracking-tight text-[rgb(var(--palette-white))] sm:text-[2.75rem]">
            {{ t('pages.index.steamTopUp.title') }}
          </h1>
          <p class="mt-3 text-sm text-[rgb(var(--palette-gray-400))] sm:text-base">
        ...
        <div class="mx-auto w-full max-w-[680px]">
          <p
            ...
            class="mb-5 rounded-lg border border-[rgb(var(--palette-yellow-500)/0.3)] bg-[rgb(var(--palette-yellow-500)/0.1)] px-4 py-3 text-sm text-[rgb(var(--palette-yellow-100))]"
          >
          ...
          <template v-else>
            <p
              v-if="steamError"
              class="mb-5 rounded-lg border border-[rgb(var(--palette-red-500)/0.3)] bg-[rgb(var(--palette-red-500)/0.1)] px-4 py-3 text-sm text-[rgb(var(--palette-red-200))]"
            >
              {{ steamError }}
            </p>
            <p
              v-if="steamSuccess"
              class="mb-5 rounded-lg border border-[rgb(var(--palette-emerald-500)/0.3)] bg-[rgb(var(--palette-emerald-500)/0.1)] px-4 py-3 text-sm text-[rgb(var(--palette-emerald-200))]"
            >
              {{ steamSuccess }}
            </p>
            <p
              v-if="steamServicesLoading"
              class="mb-5 rounded-lg border border-[rgb(var(--palette-dark-600))] bg-[rgb(var(--palette-dark-700)/0.5)] px-4 py-3 text-sm text-[rgb(var(--palette-gray-300))]"
            >
            ...
            <div class="space-y-5">
              <label class="block space-y-2">
                <span class="block text-sm font-medium text-[rgb(var(--palette-gray-300))]">
              ...
              <label class="block space-y-2">
                ...
                >
                  <template #append>
                    <span class="text-sm font-medium text-[rgb(var(--palette-gray-400))]">{{ currencySymbol }}</span>
                  </template>
                </TheInput>
              </label>
              ...
              >
                <p v-if="steamPromoValidationLoading" class="text-[rgb(var(--palette-blue-200))]">
                  Проверяем промокод...
                </p>
                <p v-else-if="steamPromoValidationError" class="text-[rgb(var(--palette-red-200))]">
                  {{ steamPromoValidationError }}
                </p>
                <template v-else-if="steamPromoValidationResult">
                  <p class="text-[rgb(var(--palette-emerald-200))]">
                    Промокод применится: скидка {{ formatRubAmount(steamPromoValidationResult.discount_amount) }}.
                  </p>
                  <p class="mt-1 text-[rgb(var(--palette-gray-300))]">
              ...
              <div class="flex flex-wrap gap-2">
                <button
                  ...
                  :class="isQuickAmountActive(amount)
                    ? 'border-[rgb(var(--palette-blue-500)/0.45)] bg-[rgb(var(--palette-blue-500)/0.15)] text-[rgb(var(--palette-white))]'
                    : 'border-[rgb(var(--palette-dark-700))] bg-[rgb(var(--palette-dark-600)/0.6)] text-[rgb(var(--palette-gray-300))] hover:border-[rgb(var(--palette-dark-500))] hover:bg-[rgb(var(--palette-dark-600))] hover:text-[rgb(var(--palette-white))]'"
