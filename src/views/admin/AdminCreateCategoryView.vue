      ...
      <div class="mt-8">
        <div class="space-y-6">
          <section class="rounded-2xl border border-[rgb(var(--palette-dark-700))] bg-[rgb(var(--palette-dark-600)/0.3)] p-4 lg:p-5">
            ...
            >
              <div class="text-xs uppercase tracking-[0.16em] text-[var(--text-meta)]">
                {{ t('pages.admin.categoryCreate.parentCategory') }}
              </div>
              <div v-if="isLoadingParent" class="mt-2 inline-flex items-center gap-2 text-sm text-[var(--text-muted)]">
                <Loader2 class="h-4 w-4 animate-spin" />
                {{ t('common.loading') }}
              </div>
              <div v-else class="mt-2 text-sm font-medium text-[var(--text-title)]">
            ...
            <div class="space-y-5">
              <div class="space-y-3">
                <div class="flex items-center justify-between gap-3">
                  ...
                  <span
                    class="text-xs"
                    :class="hasImage ? 'text-[var(--text-muted)]' : 'text-[var(--text-danger)]'"
                  >
          ...
          <div class="rounded-2xl border border-[rgb(var(--palette-dark-700))] bg-[rgb(var(--palette-dark-600)/0.3)] p-4 lg:p-5">
            <div class="rounded-xl border border-[rgb(var(--palette-dark-700))] bg-[rgb(var(--palette-dark-700)/0.4)] p-3 text-xs leading-5 text-[var(--text-muted)]">
