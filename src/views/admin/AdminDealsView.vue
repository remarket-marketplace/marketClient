  ...
  <section class="h-full w-full flex flex-col gap-3 sm:gap-6 overflow-hidden">
    ...
    <div class="flex-1 overflow-hidden">
      ...
      <div v-else class="h-full overflow-y-auto no-scrollbar space-y-4">
          ...
          <div class="flex flex-col gap-4">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center gap-2">
                      <span class="text-mainText font-light truncate">
            ...
            <div class="flex flex-col sm:flex-row sm:flex-wrap gap-2 pt-2 border-t border-dark-700">
              ...
              <template v-else-if="deal.status === 'completed'">
                <div
                  class="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-gray-600 text-gray-300 rounded-lg text-sm">
              ...
              <template v-else-if="deal.status === 'refunded'">
                <div
                  class="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-purple-600 text-purple-300 rounded-lg text-sm">
                  <Undo2 class="w-4 h-4" />
              ...
              <!-- Общая кнопка отмены -->
              <button v-if="['pending', 'disputed'].includes(deal.status)" @click="cancelDeal(deal.id)"
        ...
        <!-- Кнопка загрузки еще -->
        <div v-if="isServerPagination && currentPage < totalPages" class="flex items-center justify-center pt-4">
          <button
            ...
            :disabled="isLoadingMore" @click="loadMoreDeals">
