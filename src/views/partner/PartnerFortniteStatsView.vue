...
<template>
  <section class="w-full min-h-[calc(100vh-120px)] pb-10 pt-6">
    <div class="max-w-6xl mx-auto px-2 lg:px-0 flex flex-col gap-4">
      <div class="rounded-2xl border border-dark-500/50 bg-dark-700/70 p-5">
      ...
      <div v-if="isLoading" class="rounded-2xl border border-dark-500/50 bg-dark-700/70 p-10 flex justify-center">
        <Loader />
      </div>
      ...
      <template v-else>
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3">
          <div
            ...
            :key="card.key"
            class="rounded-xl border border-dark-500/60 bg-dark-700/70 p-4"
          >
        ...
        <div class="rounded-2xl border border-dark-500/50 bg-dark-700/70 p-4">
          ...
          <div v-if="statusRows.length" class="overflow-x-auto">
            <table class="w-full text-sm">
              <thead>
                <tr class="text-left text-gray-400 border-b border-dark-500/60">
              ...
              <tbody>
                <tr
                  ...
                  :key="item.status"
                  class="border-b border-dark-500/30 last:border-b-0"
                >
